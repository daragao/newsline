...
silent only
cd ~/Documents/WORK/andre/frontend/app
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +1 scripts/main.js
badd +0 scripts/views/graph.js
badd +36 scripts/views/chartBase.js
badd +2 scripts/templates/graph.ejs
args scripts/main.js
edit scripts/views/chartBase.js
